...
class MessagingAction {
  ...
  */
  queue_worker(queue_name = null, prefetch = 3, durable = true) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield channel.assertQueue(queue_name, { durable });
  ...
  */
  rpc_client(queue_name = null, payload = null, correlationId = null, callback = null, options) {
    var _this5 = this;
    ...
    return _asyncToGenerator(function* () {
      ...
      let consumer = yield channel.consume(q.queue, (() => {
      ...
      if (options) {
        if (options.ttl) {
          ...
          setTimeout(_asyncToGenerator(function* () {
            if (!consumed) {
              yield channel.cancel(consumer.consumerTag);
              yield channel.deleteQueue(q.queue);
      ...
      let the_queue = channel.sendToQueue(queue_name, new Buffer(self.stringify_payload), queue_args);
    })();
  }
